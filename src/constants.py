...
KEY_TO_PIN_MAP = {
    ...
    pygame.K_LEFT: PIN_BNEXT,
    pygame.K_RIGHT: PIN_RIGHT,
    pygame.K_UP: PIN_RIGHT,
    pygame.K_RETURN: PIN_BENTER,
    pygame.K_SPACE: PIN_BENTER,
    pygame.K_1: PIN_H20[0],
    pygame.K_2: PIN_H25[0],
    pygame.K_3: PIN_H40[0],
    pygame.K_4: PIN_H50[0],
    pygame.K_5: PIN_H100[0],
    pygame.K_6: PIN_HBOTTLE[0],
    pygame.K_7: PIN_HSFROG[0],
    pygame.K_8: PIN_HLFROG[0],
    pygame.K_KP1: PIN_H20[0],
    pygame.K_KP2: PIN_H25[0],
    pygame.K_KP3: PIN_H40[0],
    pygame.K_KP4: PIN_H50[0],
    pygame.K_KP5: PIN_H100[0],
    pygame.K_KP6: PIN_HBOTTLE[0],
    pygame.K_KP7: PIN_HSFROG[0],
    pygame.K_KP8: PIN_HLFROG[0],
...
ORDER_TARGET_SEQUENCE = [
    ...
    ("side", "100", "100"),
    ("bottle", "150", "150"),
    ("little_frog", "200", "Petite grenouille"),
    ("large_frog", "ROUL", "Roulette"),
    ("little_frog", "200", "Petite grenouille"),
    ("bottle", "150", "150"),
    ("side", "100", "100"),
    ("side", "50", "50"),
...
ACTION_COOLDOWN = 1.0
BLINK_INTERVAL = 0.2
GOAL_ANIMATION_DURATION = 1.2
COMBO_BONUS_STEP = 20
COMBO_BONUS_CAP = 60
PRESSURE_BONUS = 30
PRESSURE_GAP = 120
PRESSURE_TRIGGER_POINTS = 100
FINAL_RUSH_THRESHOLD = 0.75
FINAL_RUSH_BONUS = 25
